...
function ticket_changePoint(amt,pnt,min,unit){
	...
	console.log(amt * 0.03); // 포인트 
	console.log( ( amt - x ) * 0.03 ); // 할인금액 합산한 포인트 
	console.log( ( amt * 0.03 )-( x * 0.03 ) ); // 할인금액 합산한 포인트 
	console.log( ( amt * 0.03 )-( x * 0.03 ) - ( return_point * 0.03 ) ); // 할인금액 합산한 포인트 
	console.log( return_point * 0.03 ); // 최종결제금액에대한 포인트.
	
	
	document.getElementById("result_pnt").innerHTML
		= amt - x - return_point; // 최종 결제금액 = 결제금액 - 사용할 포인트 - 할인금액 
	document.getElementById("result_point").innerHTML 
		= (( amt - x )* 0.03 ) - ( return_point*0.03 ); // 최종 포인트 = ( 결제금액 -할인금액 * 0.03) - 최종결제금액에대한 포인트
