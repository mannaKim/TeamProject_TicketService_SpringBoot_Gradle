		...
		<table>
			<tr>
				<td><img src="/goods_images/sub_images/gs_icon_01.png"
					width="140px" onClick="location.href='goodsCategory?kind=1&page=1'"></td>
				<td><img src="/goods_images/sub_images/gs_icon_02.png"
					width="140px" onClick="location.href='goodsCategory?kind=2&page=1'"></td>
				<td><img src="/goods_images/sub_images/gs_icon_03.png"
					width="140px" onClick="location.href='goodsCategory?kind=3&page=1'"></td>
				<td><img src="/goods_images/sub_images/gs_icon_04.png"
					width="140px" onClick="location.href='goodsCategory?kind=4&page=1'"></td>
				<td><img src="/goods_images/sub_images/gs_icon_05.png"
					width="140px" onClick="location.href='goodsCategory?kind=5&page=1'"></td>
			</tr>
			<tr>
				<td><a href="goodsCategory?kind=1&page=1">문구</a></td>
				<td><a href="goodsCategory?kind=2&page=1">디지털</a></td>
				<td><a href="goodsCategory?kind=3&page=1">가방 · 파우치</a></td>
				<td><a href="goodsCategory?kind=4&page=1">취미용품</a></td>
				<td><a href="goodsCategory?kind=5&page=1">패션 · 잡화</a></td>
			</tr>
		</table>
	</div>
</div>