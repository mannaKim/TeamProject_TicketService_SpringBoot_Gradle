...
<article>
	<form action="m_goodsOrderInsertOne" method="post" name="goodsFrm">
		...
		<div class="goodsBox">
			<div class="goodsCart">
				...
				<div class="goodsCartBox">
					<a href="m_goodsDetail?gseq=${goodsVO.GSEQ}">
				...
				<div class="goodsCartButton">
					<input type="button" value="취소" class="goodsButton2"
						onClick="location.href='m_goodsDetail?gseq=${goodsVO.GSEQ}'">
				</div>
				<div class="goodsCartButton">
