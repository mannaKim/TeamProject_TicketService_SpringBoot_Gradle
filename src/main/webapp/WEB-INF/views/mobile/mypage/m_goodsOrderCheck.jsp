...
<article>
	<form action="m_goodsOrderInsert" method="post" name="goodsFrm">
		<div class="goodsBox">
			<div class="goodsCart">
				<br>
				<br>
				<table id="orderCheck">
					...
					<tr>
						<td align="center" colspan="3">
							...
							name="address2" value="${loginUser.address2}" size="30"> <br> <input
							type="text" id="sample6_extraAddress" placeholder="참고항목"
							name="address3" value="${loginUser.address3}" size="30" readonly>
				...
				<br>
				<c:forEach items="${goodsCartListToBuy}" var="goods">
					<input type="hidden" name="gcseq" value="${goods.GCSEQ}">
					<div class="goodsCartBox">
						<a href="m_goodsDetail?gseq=${goods.GSEQ}">
							<img src="/goods_images/${goods.IMAGE}">
						</a>
						<br>
						<a href="m_goodsDetail?gseq=${goods.GSEQ}"> 
								${goods.GNAME}		
						...
						${goods.QUANTITY} 개 <br>
						<fmt:formatNumber value="${goods.PRICE*goods.QUANTITY}" type="currency" />
						<hr>
					</div>
				</c:forEach>
				<br>
				...
				<div class="goodsCartButton">
					<input type="button" value="취소" class="goodsButton2"
						onClick="location.href='m_goodsCartList'">
				</div>
				<div class="goodsCartButton">
