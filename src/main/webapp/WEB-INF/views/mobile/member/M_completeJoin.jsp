		...
		<c:choose>
			<c:when test="${suc!=0}">
				...
				<div class="comjoin_btn">
					<input type="button" value="메인으로" onClick="location.href='/'" class="m_comjoin_btn">
					<input type="button" value="로그인" onClick="location.href='MloginForm'" class="m_comjoin_btn">
				</div>
			</c:when>
			<c:otherwise>
				...
				<div class="comjoin_btn">
					<input type="button" value="메인으로" onClick="location.href='/'" class="m_comjoin_btn">
					<input type="button" value="회원가입" onClick="location.href='MtermsAndConditions'" class="m_comjoin_btn">
				</div>
			</c:otherwise>
		</c:choose>	
	</div>
