...
<article>
	<form action="goodsOrderInsert" method="post" name="goodsFrm">
		<div class="goodsBox">
			<div class="goodsCart">
				<br>
				<br>
				...
				<table id="orderCheck">
					...
					<c:forEach items="${goodsCartListToBuy}" var="goods">
						...
						<tr>
							<td width="300px"><a href="goodsDetail?gseq=${goods.GSEQ}">
									<img src="/goods_images/${goods.IMAGE}">
							</a></td>
							<td><a href="goodsDetail?gseq=${goods.GSEQ}">
									${goods.GNAME} </a></td>
							<td>${goods.QUANTITY}</td>
							<td><fmt:formatNumber value="${goods.PRICE*goods.QUANTITY}"
									type="currency" /></td>
						</tr>
					</c:forEach>
				</table>
				...
				<div class="goodsCartButton" id="orderCheckButton">
					<input type="button" value="취소" class="goodsButton2"
						onClick="location.href='goodsCartList'">
